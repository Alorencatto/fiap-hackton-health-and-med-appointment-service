...
def test_doctor_notification_subscriber_subscriber_initialization(mock_connect):
    mock_appointment_service = MagicMock()
    mock_connection_params = MagicMock()

    subscriber = DoctorNotificationSubscriber(
        appointment_service=mock_appointment_service,
        connection_params=mock_connection_params,
    )

    assert subscriber.appointment_service == mock_appointment_service
